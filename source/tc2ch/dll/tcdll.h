...
//#define CLOCKM_UPDATE_FORMAT  (WM_USER + 3)
#define CLOCKM_UPDATE_EXTTEXT  (WM_USER + 4)
...
#define CLOCKM_QUERY_HEALTH (WM_USER+213)
#define CLOCKM_REQUEST_RECOVERY (WM_USER+214)

#define CLKR_RELAYOUT_ONLY 1
...
#define IDTIMERDLL_STARTUP_AUTOADJUST	18
